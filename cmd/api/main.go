...
import (
	...
	_ "github.com/lib/pq"
	"greenlight.hoangdv99/internal/data"
	"greenlight.hoangdv99/internal/jsonlog"
...
func main() {
	...
	flag.StringVar(&cfg.db.maxIdleTime, "db-max-idle-time", "15m", "Postgres SQL max connection idle time")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "c8e8f03d52df4f", "SMTP username")
